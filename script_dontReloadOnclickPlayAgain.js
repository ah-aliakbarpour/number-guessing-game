...
let timerChanger, remainingSeconds, userInputCounter = 0, functionStartTimerExecuted = false;
...
guessButton.onclick = function handleUserInput(){
    if (!functionStartTimerExecuted){
        startTimer();
        functionStartTimerExecuted = true;
    }
...
playAgainButton.onclick = function playAgain(){
    ...
    for (const chance of chances){
        chance.style.fontSize = "5px";
        chance.style.backgroundColor = "unset";
    }
    chances[0].style.backgroundColor = "rgba(34,140,226,0.3)";
    chances[0].style.fontSize = "8px";
    ...
    userInputCounter = 0;
    functionStartTimerExecuted = false;
